...
import { Text, View, StyleSheet, Image, Pressable, ScrollView, TextInput } from "react-native";
  ...
  return <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.flexRow}>
          ...
          <Image style={styles.icon} source={require("./assets/closeIcon.png")} />
        </View>
        ...
        <Pressable style={styles.flexRow} onPress={() => handleExpand(0)}>
          ...
          <Image style={styles.icon} source={expanded.includes(0) ? require("./assets/dropdownIconExpanded.png") : require("./assets/dropdownIconCollapsed.png")} />
        </Pressable>
        {expanded.includes(0) && <View style={styles.cardContainer}>
            {sizeOptions.map((option, index) => <View key={index} style={styles.optionContainer}>
                <Checkbox value={option === selectedSize} setValue={() => setSelectedSize(option)} />
        ...
        {expanded.includes(1) && <View style={styles.cardContainer}>
            {workOptions.map((option, index) => <View key={index} style={styles.optionContainer}>
                <Checkbox value={option === selectedWork} setValue={() => setSelectedWork(option)} />
                <Text style={styles.optionText}>
                  {option.label} {"\t"}
        ...
        <Input text="Add instructions" value={description} onChange={setDescription} placeholder="Type instructions here..." textArea={true} containerStyle={styles.inputContainer} />
