...
export const api_v1_recipe_list = createAsyncThunk("recipes/api_v1_recipe_list", async payload => {
  const response = await apiService.api_v1_recipe_list(payload);
  return response.data;
});
export const api_v1_recipe_create = createAsyncThunk("recipes/api_v1_recipe_create", async payload => {
  const response = await apiService.api_v1_recipe_create(payload);
  return response.data;
});
export const api_v1_recipe_retrieve = createAsyncThunk("recipes/api_v1_recipe_retrieve", async payload => {
  const response = await apiService.api_v1_recipe_retrieve(payload);
  return response.data;
});
export const api_v1_recipe_update = createAsyncThunk("recipes/api_v1_recipe_update", async payload => {
  const response = await apiService.api_v1_recipe_update(payload);
  return response.data;
});
export const api_v1_recipe_partial_update = createAsyncThunk("recipes/api_v1_recipe_partial_update", async payload => {
  const response = await apiService.api_v1_recipe_partial_update(payload);
  return response.data;
});
export const api_v1_recipe_destroy = createAsyncThunk("recipes/api_v1_recipe_destroy", async payload => {
